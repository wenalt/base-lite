...
// (optionnel mais recommandé pour le style du bouton/modal)
import '@reown/appkit-css/dist/appkit.css'

// --- ENV ---
const projectId = process.env.NEXT_PUBLIC_REOWN_PROJECT_ID
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'

// Petit garde-fou en build/dev
...
export const appKit = createAppKit({
  ...
  metadata: {
    ...
    url: siteUrl, // Doit correspondre à l’origin réel en prod

...
const metadata = {
  ...
  url: process.env.NEXT_PUBLIC_SITE_URL ?? 'https://your-base-lite-url.vercel.app',
  icons: [
    (process.env.NEXT_PUBLIC_SITE_URL ?? 'https://your-base-lite-url.vercel.app') + '/baseicon.png'
  ]
}
